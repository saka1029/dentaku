...
public class TestFunctions {
    ...
    public void testUnaryOperators() {
        ...
        assertEquals(value("0 1 -1 0"), eval(c, "int sin 0 (PI / 2) (-PI / 2) PI"));
        assertEquals(value("1 0 0 -1"), eval(c, "int cos 0 (PI / 2) (-PI / 2) PI"));
        assertEquals(value("0 1 -1 0"), eval(c, "int tan 0 (PI / 4) (-PI / 4) PI"));
